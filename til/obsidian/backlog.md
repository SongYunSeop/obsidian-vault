...
## 선행 지식
- [x] [[til/obsidian/yaml-frontmatter|YAML Frontmatter]] - 노트 상단에 `---`로 감싸는 메타데이터 블록 형식
- [x] [[til/obsidian/pkm|PKM]] - 개인 지식 관리(Personal Knowledge Management)의 기본 개념과 목적
...
- [ ] [[til/obsidian/callout-embed|Callout과 Embed]] - `> [!callout]` 블록과 `![[노트]]` 임베딩 문법
...
- [ ] [[til/obsidian/canvas|Canvas]] - 무한 화이트보드. 노트, 이미지, 카드를 자유 배치하는 시각적 도구
...
- [ ] [[til/obsidian/plugin-development|Plugin 개발]] - TypeScript API, Plugin 클래스 라이프사이클, esbuild 빌드 시스템
