...
- [테스트 주도 개발(TDD)](til/agile-story/tdd.md) - Red-Green-Refactor 사이클의 리팩토링 단계
- [익스트림 프로그래밍(XP)](til/agile-story/xp.md) - 리팩토링을 핵심 실천법으로 하는 방법론
- [짝 프로그래밍(Pair Programming)](til/agile-story/pair-programming.md) - 리팩토링 중 실시간 피드백 제공
- [피드백 루프(Feedback Loop)](til/agile-story/feedback-loop.md) - CI를 통한 리팩토링 검증의 빠른 피드백
